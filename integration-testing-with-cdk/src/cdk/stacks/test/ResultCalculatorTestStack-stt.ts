...
export default class ResultCalculatorTestStack extends IntegrationTestStack {
  ...
  constructor(scope: cdk.Construct, id: string) {
    ...
    super(scope, id, {
      ...
      mockIds: [ResultCalculatorTestStack.FileHeaderIndexReaderMockId],
    });
    ...
    const sut = new ResultCalculator(this, 'SUT', {
      ...
      fileHeaderIndexReaderFunction:
        this.testFunctions[ResultCalculatorTestStack.FileHeaderIndexReaderMockId],
    ...
    sut.errorTopic.addSubscription(
      new snsSubs.LambdaSubscription(
        this.testFunctions[ResultCalculatorTestStack.ErrorTopicObserverId]
      )
    );
    ...
    testBucket.addEventNotification(
      ...
      new s3n.LambdaDestination(
        this.testFunctions[ResultCalculatorTestStack.BucketEventObserverId]
      )
    );
  }
}
