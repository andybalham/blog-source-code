...
export default class CreditReferenceApi extends cdk.Construct {
  constructor(scope: cdk.Construct, id: string, props: CreditReferenceApiProps) {
    ...
    const mockApiFunction = new lambdaNodejs.NodejsFunction(this, 'CreditReferenceFn');

    httpApi.addRoutes({
      path: '/request',
      methods: [HttpMethod.POST],
      integration: new HttpLambdaIntegration('CreditReferenceApiIntegration', mockApiFunction),
    });
